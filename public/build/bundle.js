    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(rect0, file$2, 10, 8, 521);
    			attr_dev(rect1, "x", "3");
    			attr_dev(rect1, "y", "17");
    			attr_dev(rect1, "width", "7");
    			attr_dev(rect1, "height", "6");
    			add_location(rect1, file$2, 11, 8, 577);
    			attr_dev(rect2, "x", "14");
    			attr_dev(rect2, "y", "1");
    			attr_dev(rect2, "width", "7");
    			attr_dev(rect2, "height", "6");
    			add_location(rect2, file$2, 12, 8, 633);
    			attr_dev(rect3, "x", "14");
    			attr_dev(rect3, "y", "11");
    			attr_dev(rect3, "width", "7");
    			attr_dev(rect3, "height", "12");
    			add_location(rect3, file$2, 13, 8, 689);
    			...
    			add_location(img, file$2, 17, 4, 867);
    			attr_dev(path0, "fill", "currentColor");
    			attr_dev(path0, "d", "M23,13H1c-0.6,0-1-0.4-1-1s0.4-1,1-1h22c0.6,0,1,0.4,1,1S23.6,13,23,13z");
    			add_location(path0, file$2, 23, 10, 1326);
    			attr_dev(path1, "fill", "currentColor");
    			attr_dev(path1, "d", "M23,6H1C0.4,6,0,5.6,0,5s0.4-1,1-1h22c0.6,0,1,0.4,1,1S23.6,6,23,6z");
    			add_location(path1, file$2, 24, 10, 1444);
    			attr_dev(path2, "fill", "currentColor");
    			attr_dev(path2, "d", "M23,20H1c-0.6,0-1-0.4-1-1s0.4-1,1-1h22c0.6,0,1,0.4,1,1S23.6,20,23,20z");
    			add_location(path2, file$2, 25, 10, 1558);
    			attr_dev(svg1, "class", "w-5 text-gray-600");
    			attr_dev(svg1, "viewBox", "0 0 24 24");
    			add_location(svg1, file$2, 22, 8, 1264);
    			attr_dev(button0, "id", "open");
    			attr_dev(button0, "class", "p-2 -mr-1 transition duration-200 rounded \n        focus:outline-none focus:shadow-outline hover:bg-purple-50 focus:bg-deep-purple-50 svelte-8hp1mx");
    			add_location(button0, file$2, 20, 6, 1095);
    			...
    			add_location(path3, file$2, 31, 10, 1929);
    			attr_dev(svg2, "class", "w-5 text-gray-600");
    			attr_dev(svg2, "viewBox", "0 0 24 24");
    			add_location(svg2, file$2, 30, 8, 1867);
    			attr_dev(button1, "id", "close");
    			attr_dev(button1, "class", "p-2 -mr-1 transition duration-200 rounded \n        hover:bg-purple-50 focus:bg-gray-200 focus:outline-none focus:shadow-outline svelte-8hp1mx");
    			add_location(button1, file$2, 28, 6, 1703);
    			attr_dev(div0, "class", "lg:hidden svelte-8hp1mx");
    			toggle_class(div0, "active", /*active*/ ctx[0]);
    			add_location(div0, file$2, 19, 4, 1019);
    			attr_dev(div1, "class", "relative flex items-center justify-between");
    			add_location(div1, file$2, 7, 2, 176);
    			attr_dev(div2, "class", "px-4 py-5 mx-auto sm:max-w-xl md:max-w-full lg:max-w-full md:px-24 lg:px-8");
    			add_location(div2, file$2, 6, 0, 85);
    			attr_dev(div3, "class", "side-bar items-stretch md:items-center svelte-8hp1mx");
    			toggle_class(div3, "active", /*active*/ ctx[0]);
    			add_location(div3, file$2, 41, 0, 2352);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
