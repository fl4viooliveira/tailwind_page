    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button0, file$3, 20, 6, 1095);
    			...
    			add_location(path3, file$3, 31, 10, 1929);
    			attr_dev(svg2, "class", "w-5 text-gray-600");
    			attr_dev(svg2, "viewBox", "0 0 24 24");
    			add_location(svg2, file$3, 30, 8, 1867);
    			...
    			add_location(div3, file$3, 41, 0, 2352);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$2, 11, 4, 195);
    			add_location(h20, file$2, 18, 12, 567);
    			attr_dev(li0, "class", "items-center p-4 m-6 bg-white rounded-lg shadow-purple");
    			add_location(li0, file$2, 17, 10, 487);
    			add_location(h21, file$2, 21, 12, 729);
    			attr_dev(li1, "class", "items-center p-4 m-6 bg-white rounded-lg shadow-purple");
    			add_location(li1, file$2, 20, 10, 649);
    			add_location(h22, file$2, 24, 12, 886);
    			attr_dev(li2, "class", "items-center p-4 m-6 bg-white rounded-lg shadow-purple");
    			add_location(li2, file$2, 23, 10, 806);
    			attr_dev(ul, "class", "w-auto");
    			add_location(ul, file$2, 16, 8, 457);
    			attr_dev(div1, "class", "w-full justify-self-center");
    			add_location(div1, file$2, 15, 6, 408);
    			...
    			add_location(img0, file$2, 31, 12, 1140);
    			...
    			add_location(img1, file$2, 34, 12, 1318);
    			attr_dev(div2, "class", "flex flex-col items-end px-3");
    			add_location(div2, file$2, 30, 10, 1085);
    			...
    			add_location(img2, file$2, 38, 12, 1525);
    			attr_dev(div3, "class", "px-3");
    			add_location(div3, file$2, 37, 10, 1494);
    			attr_dev(div4, "class", "flex items-center justify-center -mx-4 lg:pl-8");
    			add_location(div4, file$2, 29, 8, 1014);
    			attr_dev(div5, "class", "w-full");
    			add_location(div5, file$2, 28, 6, 985);
    			attr_dev(div6, "class", "flex flex-wrap mt-10 xl:flex-nowrap sm:flex-wrap");
    			add_location(div6, file$2, 14, 4, 339);
    			attr_dev(div7, "class", "flex flex-col w-full");
    			add_location(div7, file$2, 10, 2, 156);
    			attr_dev(div8, "class", "flex flex-row");
    			add_location(div8, file$2, 6, 0, 64);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
