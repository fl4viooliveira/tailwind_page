    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t4 = space();
    			div2 = element("div");
    			div2.textContent = "images";
    			t6 = space();
    			div4 = element("div");
    			div4.textContent = "cards";
    			...
    			add_location(div1, file$2, 15, 6, 373);
    			add_location(div2, file$2, 18, 6, 414);
    			attr_dev(div3, "class", "flex flex-row");
    			add_location(div3, file$2, 14, 4, 338);
    			add_location(div4, file$2, 22, 4, 464);
    			attr_dev(div5, "class", "flex flex-col w-full");
    			add_location(div5, file$2, 10, 2, 156);
    			attr_dev(div6, "class", "flex flex-row");
    			add_location(div6, file$2, 6, 0, 64);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file, 187380, 2, 4410884);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
